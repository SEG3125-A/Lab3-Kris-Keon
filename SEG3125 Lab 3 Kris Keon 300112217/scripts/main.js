...
function populateListProductChoices(slct1, slct2) {
	...
	var priceArray = restrictListPrices(products, s1.value);
	...
	for (i = 0; i < optionArray.length; i++) {
		...
		var productImage = products.find(product => product.name === productName).image;

		// create an image and add in HTML DOM
